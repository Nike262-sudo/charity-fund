...
export function Donation() {
  ...
  const copyAccountNumber = () => {
    navigator.clipboard.writeText('0049462000').then(() => {
      setCopied(true);
      setTimeout(() => setCopied(false), 2500);
    }).catch(() => {
      alert('Could not copy automatically. Please copy the account number manually: 0049462000');
    });
  };
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-3 gap-3">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <span className="text-lg font-extrabold text-[#1a4731] tracking-widest">0049462000</span>
                  <motion.button
        ...
        <FadeIn delay={0.3}>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.171-1.761-1.309-2.059-.138-.297-.015-.458.104-.606.106-.133.237-.347.355-.52.118-.173.158-.297.237-.495.079-.198.04-.371-.02-.52-.06-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.371-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.064 2.875 1.212 3.074.149.198 2.095 3.2 5.076 4.487.709.306 1.262.489 1.694.626.712.226 1.36.194 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.642 0 5.122 1.03 6.988 2.898a9.83 9.83 0 0 1 2.896 6.994c-.003 5.45-4.437 9.884-9.888 9.884m8.413-18.297A11.82 11.82 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L0 24l6.306-1.654a11.86 11.86 0 0 0 5.741 1.47h.005c6.554 0 11.89-5.335 11.893-11.892a11.82 11.82 0 0 0-3.481-8.413" />
            </svg>
